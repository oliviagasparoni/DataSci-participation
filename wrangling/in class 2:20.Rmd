...
1. Would you say this data is in tidy format?
   ...
   No because multiple rows equate to one observation.
...
#sep will identify what you separate the values by. if it was an _ it would be sommer_medrano. the first argument (col="name") will decide what to call the column. first,last is the columns that we are combining
```
